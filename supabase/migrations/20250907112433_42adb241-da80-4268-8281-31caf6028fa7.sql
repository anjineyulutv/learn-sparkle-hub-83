-- First, let's create Anjineyulu's profile if it doesn't exist
INSERT INTO public.profiles (user_id, username, display_name, bio) 
VALUES (
  gen_random_uuid(),
  'anjineyulu', 
  'Anjineyulu',
  'Community Builder & AI Enthusiast | Helping students navigate AI/ML careers'
) 
ON CONFLICT (user_id) DO NOTHING;

-- Get the user_id for Anjineyulu (we'll use a consistent UUID)
DO $$
DECLARE
    anjineyulu_user_id UUID := '00000000-0000-0000-0000-000000000001';
BEGIN
    -- Insert or update Anjineyulu's profile with consistent UUID
    INSERT INTO public.profiles (user_id, username, display_name, bio)
    VALUES (
        anjineyulu_user_id,
        'anjineyulu',
